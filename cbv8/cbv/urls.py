...
from .views import (
		...
		ProductTemplateView,
		ProductFoodListView,
		ProductDrinkListView,
		ProductNoodleListView
	)
urlpatterns = [
	url(r'^$',IndexView.as_view(),name="index_view"),
	url(r'^products/$',ProductListView.as_view(),name="product-list"),
	url(r'^products/food/$',ProductFoodListView.as_view(),name="product-food"),
	url(r'^products/drink/$',ProductDrinkListView.as_view(),name="product-drink"),
	url(r'^products/noodle/$',ProductNoodleListView.as_view(),name="product-noodle"),
